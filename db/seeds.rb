...
Location.create(start_date: '2013-03-09', end_date: '2013-12-21', name: 'The Canadian', address: '139 Pearl St, Cardiff, South Glamorgan CF24 1PN', comments: 'Thursday and Friday evenings, from 5pm', url: 'http://www.sabrain.com/canadian-hotel', active: true)
Location.create(start_date: '2014-02-05', end_date: '2014-05-26', name: 'The Lansdowne', address: '71 Beda Rd, Cardiff, South Glamorgan CF5 1LX', comments: 'Thursday and Friday evenings, from 5pm',  url: 'http://thelansdownecardiff.co.uk', active: true)
Location.create(start_date: '2014-10-02', end_date: '2014-11-29',  name: 'The New Pilot', address: '67 Queens Rd, Penarth, Vale of Glamorgan CF64 1DJ', comments: 'Wednesday evenings, from 5pm',  url: 'http://knifeandforkfood.co.uk/pilot', active: true)
